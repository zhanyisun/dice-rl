...
class EvalAgent:
    ...
    def __init__(self, cfg):
        ...
        loadpath = cfg.base_policy_path
        ckpt = torch.load(loadpath, map_location=self.device, weights_only=True)
        self.model.load_state_dict(ckpt["model"])  # or ckpt["model"] if you prefer non-EMA
